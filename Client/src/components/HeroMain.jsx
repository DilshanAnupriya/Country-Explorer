    ...
    <div className="relative h-screen w-full flex items-center justify-center overflow-hidden bg-gradient-to-br from-blue-900 via-red-800 to-yellow-500 bg-[length:300%_300%] animate-gradient">
      ...
      <div className="max-w-6xl w-11/12 flex flex-col  text-white z-10">
        ...
        <div className="relative w-full max-w-xl animate-fadeInUp animation-delay-600 mb-12">
          <input
            type="text"
            className="w-full py-4 px-6 rounded-full border-none text-lg shadow-lg transition-all duration-300 focus:outline-none focus:shadow-white"
            placeholder="Search for a country..."
          />
          <button
            onClick={handleSearchClick}
            className="absolute right-1 top-1 h-[calc(100%-8px)] px-6 border-none bg-gradient-to-r from-blue-500 to-blue-700 text-white rounded-full cursor-pointer transition-all duration-300 hover:scale-105 hover:from-blue-700 hover:to-blue-500"
          >
            Explore
          </button>
        </div>
...
const floatingIcons = [
  ...
  {
    path: "M12,20A8,8 0 0,0 20,12A8,8 0 0,0 12,4A8,8 0 0,0 4,12A8,8 0 0,0 12,20M12,2A10,10 0 0,1 22,12A10,10 0 0,1 12,22A10,10 0 0,1 2,12A10,10 0 0,1 12,2M12,12.5A1.5,1.5 0 0,1 10.5,11A1.5,1.5 0 0,1 12,9.5A1.5,1.5 0 0,1 13.5,11A1.5,1.5 0 0,1 12,12.5M12,7.2C9.9,7.2 8.2,8.9 8.2,11C8.2,14 12,17.5 12,17.5C12,17.5 15.8,14 15.8,11C15.8,8.9 14.1,7.2 12,7.2Z",
    top: "50%",
    left: "15%",
    width: "45px",
    duration: "22s",
