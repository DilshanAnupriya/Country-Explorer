                ...
                {!selectedRegion && !loading && (
                    ...
                    >
                        {regionData.map((region, index) => (
                            ...
                            >
                                <div className={`h-24 flex items-center justify-center bg-gradient-to-r ${getRegionStyle(region.name).gradient} text-white`}>
                                    <span className="text-4xl">{getRegionStyle(region.name).icon}</span>
                                </div>
                                <div className="p-6">
                                    <h3 className="text-xl font-bold text-gray-800 mb-2">{region.name}</h3>
                                    <p className="text-gray-600 mb-4">{region.count} countries</p>
