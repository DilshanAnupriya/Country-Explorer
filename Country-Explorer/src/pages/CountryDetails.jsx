                                ...
                                {currentUser && (
                                    <button
                                        ...
                                        className={`p-3 rounded-full shadow-md transition-all duration-300 hover:scale-110 
                                                ${isCountryFavorite ? 'bg-yellow-100 hover:bg-yellow-200' : 'bg-gray-100 hover:bg-gray-200'}`}
                                        aria-label={isCountryFavorite ? "Remove from favorites" : "Add to favorites"}
                                    >
                                        <svg
                                            className={`w-6 h-6 ${isCountryFavorite ? 'text-yellow-500 fill-current' : 'text-gray-400'}`}
