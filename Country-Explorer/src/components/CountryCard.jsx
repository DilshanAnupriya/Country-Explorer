...
const CountryCard = ({ country }) => {
    ...
    return (
        <Link
            ...
            className="group relative bg-white rounded-xl shadow-sm overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1"
            ...
            <div className="p-5 border-t border-gray-100">
                <div className="flex justify-between items-start mb-3">
                    ...
                    {currentUser && (
                        ...
                        >
                            <svg
                                className={`w-6 h-6 ${isCountryFavorite ? 'text-yellow-500 fill-current' : 'text-gray-400 hover:text-yellow-400'} transition-colors duration-300`}
